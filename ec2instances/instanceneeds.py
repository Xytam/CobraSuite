...
def getInstanceNeeds(data_file):
    ...
    for i in range(0,len(sorted_data)):
        print("Name: ",sorted_data[i]['instance_type']," / mbPerDollar: ",sorted_data[i]['mbPerDollar']," / Total Anual Cost: ",sorted_data[i]['totalCostToRun'], " / EBS Bandwidth Utilization: " sorted_data[i]['bandwidthUtilization'] )
