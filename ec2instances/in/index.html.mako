...
<%inherit file="base.mako" />
    ...
    <%block name="header">
    <h1>EC2Compare <small>Easy Amazon <b>EC2</b> Instance Comparison</small></h1>
    </%block>
    ...
    <table cellspacing="0" class="table table-bordered table-hover table-condensed" id="data">
      <thead>
        <tr>
          ...
          <th class="ebs-baseline-throughput">EBS Optimized: Basline Throughput (128K)</th>
        ...
        <tr class='instance' id="${inst['instance_type']}">
          ...
          <td class="ebs-throughput">
            <span sort="${inst['ebs_throughput']}">
              ${inst['ebs_throughput']} MBps  <!-- IS MB/s! -->
            </span>
          </td>
          <td class="ebs-iops">
          ...
          <td class="ebs-baseline-throughput">
            <span sort="${inst['ebs_baseline_throughput_mbps']}">
              ${inst['ebs_baseline_throughput_mbps']} MBps  <!-- IS MB/s! -->
            </span>
          </td>
